...
interface BalansData {
  ...
  qoldiq_avans_chiqim: number // NEW FIELD
...
export default function BalansModule() {
  ...
  useEffect(() => {
    ...
    const balansData: BalansData[] = Object.entries(filialGroups).map(([filialNomi, data], index) => ({
      ...
      qoldiq_avans_chiqim: data.chiqim.qoldiqAvans, // NEW FIELD
  ...
  const downloadCSV = () => {
    const headers = [
      ...
      "Prechisleniya",
      "Karta",
      "Qoldiq avans (chiqim)", // NEW HEADER
    ...
    const csvContent = [
      ...
      ...data.map((row) =>
        [
          ...
          row.tolangan.karta,
          row.qoldiq_avans_chiqim, // NEW DATA
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="mt-4 space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-600">Naqd:</span>
              <span className="font-medium">{totals.tolangan.naqd?.toLocaleString() || "0"} so'm</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Prechisleniya:</span>
              <span className="font-medium">{totals.tolangan.prechisleniya?.toLocaleString() || "0"} so'm</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">Karta:</span>
              <span className="font-medium">{totals.tolangan.karta?.toLocaleString() || "0"} so'm</span>
            </div>
          </div>
        </div>

          ...
          <table className="w-full">
            <thead>
              ...
              <tr className="border-b-2 border-gray-300 bg-gray-100 font-medium">
                <td className="px-3 py-3 text-sm border-r border-gray-200" colSpan={7}>
                  Jami ko'rsatkichlar:
                </td>
            ...
            <tbody>
              {filteredData.map((row, index) => (
                <tr key={row.id}
    className={`border-b border-gray-100 hover:bg-gray-50 ${row.oldingiOylardan.summasi > 1 ? "bg-red-500" : ""}`}
  >
